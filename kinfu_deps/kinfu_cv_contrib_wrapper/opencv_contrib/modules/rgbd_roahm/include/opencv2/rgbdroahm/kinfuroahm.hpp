...
#ifndef __OPENCV_RGBDROAHM_KINFUROAHM_HPP__
#define __OPENCV_RGBDROAHM_KINFUROAHM_HPP__
...
g that I need to come into la
    ...
    */
    CV_WRAP virtual bool update(InputArray depth, const Semantic& _semantic, const cv::Matx44f& externalCameraPose) = 0;
};
