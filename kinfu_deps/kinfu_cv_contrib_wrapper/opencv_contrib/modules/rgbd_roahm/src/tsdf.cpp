...
public:
    ...
    virtual void integrate(InputArray _depth, const Semantic& _semantic, float depthFactor, cv::Affine3f cameraPose, cv::kinfuroahm::Intr intrinsics) override;
...
public:
    ...
    virtual void integrate(InputArray _depth, const Semantic& _semantic, float depthFactor, cv::Affine3f cameraPose, cv::kinfuroahm::Intr intrinsics) = 0;
    virtual void raycast(cv::Affine3f cameraPose, Intr intrinsics, Size frameSize,
...
void TSDFVolumeCPU::integrate(InputArray _depth, const Semantic& semantic, float depthFactor, cv::Affine3f cameraPose, Intr intrinsics)
{
    CV_TRACE_FUNCTION();
                              ...
                              cv::Affine3f cameraPose, Intr intrinsics)
{
    ...
    ocl::ProgramSource source = ocl::rgbdroahm::tsdf_oclsrc;
