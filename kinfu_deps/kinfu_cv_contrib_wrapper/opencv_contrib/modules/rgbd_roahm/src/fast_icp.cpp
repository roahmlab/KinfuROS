...
{
public:
    ICPImpl(const cv::kinfuroahm::Intr _intrinsics, const std::vector<int> &_iterations, float _angleThreshold, float _distanceThreshold);
                          ...
                          Affine3f pose, int level, Matx66f &A, Vec6f &b) const
{
    ...
    cv::String errorStr;
    ocl::ProgramSource source = ocl::rgbdroahm::icp_oclsrc;
