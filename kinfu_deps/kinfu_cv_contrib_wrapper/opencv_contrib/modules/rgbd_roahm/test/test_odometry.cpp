...
{
    CV_OdometryTest test(cv::rgbdroahm::Odometry::create("RgbdOdometry"), 0.99, 0.89);
    test.safe_run();
}

TEST(RGBD_Odometry_ICP, algorithmic)
{
    CV_OdometryTest test(cv::rgbdroahm::Odometry::create("ICPOdometry"), 0.99, 0.99);
    test.safe_run();
}

TEST(RGBD_Odometry_RgbdICP, algorithmic)
{
    CV_OdometryTest test(cv::rgbdroahm::Odometry::create("RgbdICPOdometry"), 0.99, 0.99);
    test.safe_run();
}

TEST(RGBD_Odometry_FastICP, algorithmic)
{
    CV_OdometryTest test(cv::rgbdroahm::Odometry::create("FastICPOdometry"), 0.99, 0.99, FLT_EPSILON);
    test.safe_run();
}
